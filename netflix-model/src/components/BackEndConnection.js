...
class BackEndConnectionImpl {
    ...
    async update_tvseries(query, callback) {
        return axios.post('/tvseries/update', query, { headers: { 'Content-Type': 'application/json' } })
            .then(function (response) {
                if (callback) {
                    callback(response.data);
                }
    ...
    async get_langtons_ant(boardSize, steps, ants, callback) {
        return axios.get(`/langtons-ant/tick/board/${boardSize}/steps/${steps}/ants/${ants}`, {}, {})
            .then(function (response) {
                if (callback) {
                    callback(response.data);
                }
